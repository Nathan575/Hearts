...
public class TestCardShark{
   public static void main (String[] args){
      ...
      CardPlayerLevel1 p0 = new CardPlayerLevel1("CardPlayerNathanElias1", 0, new ArrayList<Card>());     
      CardPlayerLevel1 p1 = new CardPlayerLevel1("CardPlayerNathanElias2", 0, new ArrayList<Card>());
      CardPlayerMueller p2 = new CardPlayerMueller("CardPlayerMueller1", 0, new ArrayList<Card>());
      CardPlayerMueller p3 = new CardPlayerMueller("CardPlayerMueller2", 0, new ArrayList<Card>());
      ...
      System.out.println("Player " + p0.getName() + " is a CardPlayerLevel1");
      System.out.println("Player " + p1.getName() + " is a CardPlayerLevel1");
      System.out.println("Player " + p2.getName() + " is a CardPlayerMueller");
      System.out.println("Player " + p3.getName() + " is a CardPlayerMueller");
